...
3. [Getting started](Getting-started)
   ...
   2. [Preferences window](The-Preferences-window)
   3. [Pop-up dialogs](Pop-ups-dialogs)
   4. [Process monitor dialog](Process-monitor-dialog)
4. [Configuration](Configurations)
   ...
   9. [Nodes](Nodes)
      1. [Authentication](Nodes-authentication#nodes-authentication-added-in-v161)
      2. [Configuration examples](Nodes-authentication#configuration-examples)
      3. [Generating TLS certificates](Nodes-authentication#generating-tls-certificates)
   10. [SIEM integration](SIEM-integration)
       1. [Grafana + Loki + Promtail](SIEM-integration#howto-configure-opensnitch-with-grafanalokipromtailsyslog-ng)
       2. [ElasticSearch + LogStash + Kibana](SIEM-integration#howto-configure-opensnitch-with-elasticsearch--logstash--kibana)
