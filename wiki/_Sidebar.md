...
4. [Configuration](Configurations)
   ...
   9. [Nodes](Nodes)
      ...
      2. [Configuration examples](Nodes-authentication.md#configuration-examples)
      3. [Generating TLS certificates](Nodes-authentication.md#generating-tls-certificates)
   10. [SIEM integration](SIEM-integration)
       1. [Grafana + Loki](SIEM-integration#howto-configure-opensnitch-with-grafanalokipromtailsyslog-ng)
