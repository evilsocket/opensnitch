    ...
    def __init__(self, parent):
        ...
        self.views_config = {
            constants.TAB_MAIN: {
                "enabled": True,
                "name": "connections",
                "tabName": QC.translate("stats", "Events"),
                "isTab": True,
                "label": None,
                "cmd": None,
                "cmdCleanStats": None,
            ...
            constants.TAB_NODES: {
                "enabled": True,
                "name": "nodes",
                "tabName": QC.translate("stats", "Nodes"),
                "isTab": True,
                "label": None,
                "cmd": None,
                "cmdCleanStats": None,
            ...
            constants.TAB_RULES: {
                "enabled": True,
                "name": "rules",
                "tabName": QC.translate("stats", "Rules"),
                "isTab": True,
                "label": None,
                "cmd": None,
                "cmdCleanStats": None,
            ...
            constants.TAB_HOSTS: {
                "enabled": True,
                "name": "hosts",
                "tabName": QC.translate("stats", "Hosts"),
                "isTab": True,
                "label": None,
                "cmd": None,
                "cmdCleanStats": None,
            ...
            constants.TAB_PROCS: {
                "enabled": True,
                "name": "procs",
                "tabName": QC.translate("stats", "Applications"),
                "isTab": True,
                "label": None,
                "cmd": None,
                "cmdCleanStats": None,
            ...
            constants.TAB_ADDRS: {
                "enabled": True,
                "name": "addrs",
                "tabName": QC.translate("stats", "Addresses"),
                "isTab": True,
                "label": None,
                "cmd": None,
                "cmdCleanStats": None,
            ...
            constants.TAB_PORTS: {
                "enabled": True,
                "name": "ports",
                "tabName": QC.translate("stats", "Ports"),
                "isTab": True,
                "label": None,
                "cmd": None,
                "cmdCleanStats": None,
            ...
            constants.TAB_USERS: {
                "enabled": True,
                "name": "users",
                "tabName": QC.translate("stats", "Users"),
                "isTab": True,
                "label": None,
                "cmd": None,
                "cmdCleanStats": None,
            ...
            constants.TAB_NETSTAT: {
                "enabled": True,
                "name": "sockets",
                "tabName": QC.translate("stats", "Netstat"),
                "isTab": True,
                "label": None,
                "cmd": None,
                "cmdCleanStats": None,
            ...
            constants.TAB_FIREWALL: {
                "enabled": True,
                "name": "firewall",
                "tabName": QC.translate("stats", "Firewall"),
                "isTab": False,
                "label": None,
                "cmd": None,
                "cmdCleanStats": None,
            ...
            constants.TAB_ALERTS: {
                "enabled": True,
                "name": "alerts",
                "tabName": QC.translate("stats", "Alerts"),
                "isTab": False,
                "label": None,
                "cmd": None,
                "cmdCleanStats": None,
